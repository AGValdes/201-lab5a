...
function sumArray(sumArr) { 
  var numSum = sum(testArray[0],testArray[1], testArray[2])[0];
  console.log(numSum);
  var string = testArray + ' was passed in as an array of numbers, and ' + numSum + ' is their sum.'
  console.log(string);
...
function multiplyArray(multArr) { //eslint-disable-line
  var numProd = multiply (testArray[0], testArray[1], testArray[2])[0];
  console.log(numProd);
  var string = 'The numbers ' + testArray + ' have a product of ' + numProd + '.';
  console.log(string);
  return [numProd, string];
}
